...
urlpatterns = [
    ...
    path('menu/food/<int:pk>/add_to_order', views.add_food_line_item, name='add_food_line_item'),
    ...
    path('menu/drinks/<int:pk>/add_to_order', views.add_drink_line_item, name='add_drink_line_item'),
    path('menu/drinks/<int:drinkmenuitem_id>/add_drink_photo/', views.add_drink_photo, name='add_drink_photo'),
