...
urlpatterns = [
    ...
    path('menu/food/<int:pk>/add_to_order', views.add_food_line_item, name='add_line_item'),
    ...
    path('menu/drinks/<int:pk>/add_to_order', views.add_drink_line_item, name='add_line_item'),
